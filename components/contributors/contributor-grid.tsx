...
import { StaggerContainer, StaggerItem } from "../utils/page-reveal";
...
export default async function ContributorGrid() {
  ...
  return (
    <StaggerContainer className="mt-20 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
