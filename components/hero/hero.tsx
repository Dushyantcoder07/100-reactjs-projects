  ...
  return (
    <section className="mt-10 min-h-screen flex items-center justify-center overflow-hidden">
      <div className="relative max-w-4xl px-6 text-center">
        <FadeIn className="hidden md:block relative md:mb-5" delay={0.05}>
        ...
        <StaggerContainer className="mt-15 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <FadeIn delay={0.14} className="mt-20 flex flex-col items-center justify-center text-center">
        ...
        <StaggerContainer className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 w-full text-center">
